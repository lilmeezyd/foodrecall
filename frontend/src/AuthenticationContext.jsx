...
function AuthenticationProvider({ children }) {
  ...
  const subscribe = async (firstName, lastName, email) => {
    ...
    try {
      const response = await axios.post("https://foodrecallapi.vercel.app/api/users/subscribe", formData);
      const data = await response.data;
      setMessage(data)
      toast.success(data)
      navigate("/");
  ...
  const unsubscribe = async (id) => {
    try {
      const response = await axios.delete(`https://foodrecallapi.vercel.app/api/users/unsubscribe/${id}`);
      const data = await response.data;
      setMessage(data)
      toast.success(data)
      navigate("/");
